...
#define PWM_OUT_THRUST 6 //White grove connection  (green): 3 op multiplexer (sturen op motoren
#define PWM_OUT_HEADING   4 //Yellow grove connection (orange): 1 op multiplexer (roer)
